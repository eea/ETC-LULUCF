""""
Script that will be used to assign the output of the LB increase stats to the CSV table of NUTS regions used to upload
...
gpd_NUTS_STATS = gpd.read_file(r"L:\etc\lulucf\strata\LB_NUTS_stats\LB_stats_NUTS_EEA39_Scenario_1_2035_fix.geojson")
outfolder = r'L:\etc\lulucf\strata\LB_NUTS_stats\EEA_format'
os.makedirs(outfolder, exist_ok=True)
outname = f'IPCC_afforestation_prototype_scenario_2095_V_{str(datetime.datetime.now().date())}.csv'
