...
path_ecological_zones = os.path.join(
    Basefolder_input_data, 'IPCC', 'IPCC_data_converted', 'eco_zone_EPSG3035.gpkg')
...
CLC_IPCC_mapping = {
    ...
    'Natural_grassland': {'CLC_classes': [321, 322, 323],
                          'ID': [5]},
    'Wetlands': {'CLC_classes': [411, 412, 421, 422, 423, 511, 512, 521, 522, 523],
                 'ID': [5]},
...
CLC_IPCC_mapping_refinement = {
    'LEVEL_LULUCF': {'Settlements': [111, 112, 121,
                                     122, 123, 124,
                                     131, 132, 133,
                                     141, 142],
                     ...
                     'Wetlands': [411, 412, 421,
                                  ...
                                  523]},
    'LEVEL_SOC_classif': {
        'Artificial_surfaces': [111, 112, 121,
                                122, 123, 124,
                                131, 132, 133,
                                141, 142],
        'Non_irrigated_arable_land': [211],
        'Permanently_irrigated_arable_land': [212],
        'Rice_fields': [213],
        'Permanent_crops': [221, 222, 223],
        'Pasture': [231],
        'Heterogeneous_agro': [241, 242, 243, 244],
        'Broadleaved_forest': [311],
        'Coniferous_forest': [312],
        'Mixed_forest': [313],
        'Natural_grassland': [321],
        'Moors_heathland': [322],
        'Sclerophyllous_veg': [323],
        'Transitional_woodland_shrub': [324],
        'Open_spaces_little_no_veg': [331, 332, 333,
                                      334, 335],
        'Wetlands': [411, 412, 421,
                     422, 423, 511,
                     512, 521, 522,
